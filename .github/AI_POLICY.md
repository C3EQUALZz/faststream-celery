...
`faststream-celery` welcomes contributors who use AI tools to help build it.
With that comes a high bar: **you remain responsible for everything you
publish** — code, issue descriptions, pull request bodies, comments, and
reviews — and we take care with what we merge and release.
...
By submitting a pull request, you certify that you have the right to license
your contribution under the project's [Apache 2.0](../LICENSE) license.
AI-assisted contributions are no exception — please confirm that any
AI-generated code can be released under Apache 2.0, and does not include
third-party material you don't have the right to relicense, before you submit
it.
...
Reviews don't gate a PR — only a maintainer's approval does — but a
